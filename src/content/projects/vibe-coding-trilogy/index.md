...
Built around an Astro content collection for recipes, with a **dark, cinematic design system** built in vanilla CSS. Each recipe card is dynamically generated from a typed MDX file defining the film base, in-camera adjustments, and a set of sample photographs. EXIF data is extracted at build time using **exifr** and displayed on each photo card within the recipe detail page.
...
- More recipes to add — I have many simulation profiles I want to document properly.
